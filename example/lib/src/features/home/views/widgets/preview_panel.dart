...
class PreviewPanel extends StatelessWidget {
  const PreviewPanel({super.key, this.expanded = false});
...
class _RawCodePreview extends StatelessWidget {
  const _RawCodePreview({this.showCopyButton = true, this.expanded = false});
                  ...
                  builder: (context, ref, _) {
                    return IconButton(
                      onPressed: () {
                        copyCode(
                          context,
                          ref.read(toastDetailControllerProvider),
                        );
                      },
                      icon: const Icon(Iconsax.document_copy_copy, size: 20),
                    );
